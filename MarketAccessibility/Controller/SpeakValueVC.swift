...
class SpeakValueVC: UIViewController {
...
//    func setWaveSoundView{
//
//        speakInputView = MoneyInputView(frame: .zero)
//        speakInputView.moneyVCDelegate = collectionViewHandler
